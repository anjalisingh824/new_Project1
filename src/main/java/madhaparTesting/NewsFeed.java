...
public class NewsFeed {
	...
	public void testMagadh() throws Exception {
		...
		driver.findElement(By.id("id_newsLocation"));
		Function.dropDown(driver, 2, 3);
		Thread.sleep(5000);

		driver.findElement(By.id("id_newsCategory"));
		Function.dropDown(driver, 2, 4);
