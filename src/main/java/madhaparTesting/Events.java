...
public class Events {
	...
	public void testMagadh() throws Exception {
		...
		String timeFError = driver.findElement(By.xpath("//*[@id='event_form']/div/fieldset/div[2]/ul/li")).getText();
		timeFError.contains(Constant.TIME_ERROR);

		String imageErrorCheck = driver.findElement(By.xpath("//*[@id='event_form']/div/fieldset/div[4]/ul/li"))
				.getText();
		imageErrorCheck.contains(Constant.IMAGE_ERROR);

		String imageCheckError = driver.findElement(By.xpath("//*[@id='event_form']/div/fieldset/div[4]/ul/li"))
				.getText();
		imageCheckError.contains(Constant.IMAGE_ERROR);
